...
[![Test](https://github.com/NpoolPlatform/order-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/order-manager/actions/workflows/main.yml)
...
* make order-manager ```单独编译服务```
* make order-manager-image ```单独生成服务镜像```
