...
func CreatePayments(ctx context.Context, in []*npool.PaymentReq) ([]*npool.Payment, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CreatePayments(ctx, &npool.CreatePaymentsRequest{
			Infos: in,
		})
		if err != nil {
			return nil, err
...
func GetPaymentOnly(ctx context.Context, conds *npool.Conds) (*npool.Payment, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.GetPaymentOnly(ctx, &npool.GetPaymentOnlyRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
...
func DeletePayment(ctx context.Context, id string) (*npool.Payment, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
